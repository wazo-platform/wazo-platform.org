---
title: Install the Class 4 engine
...
[https://github.com/wazo-platform/wazo-c4-ansible/blob/master/README.md#variables](https://github.com/wazo-platform/wazo-c4-ansible/blob/master/README.md#variables).
...
The Wazo Project provides Docker containers for all the components of the Class 4 platform. You can
run a full instance of the platform on a single host using docker-compose.
