...
Consult the
[26.03 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2026.03)
for more information.

## 26.02 {#26-02}

- **Agent login/logoff behavior has changed.** Queue memberships are now persisted across agent
  login/logout cycles instead of being rebuilt from scratch. Logging in or logging off an agent
  (e.g. directly from a phone) will no longer reactivate queues. Agents logged out before the
  upgrade will have their queue associations cleared; they will need to manually re-activate their
  queues using the per-queue login/logoff API.
...
Consult the
[26.01 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2026.01)
for more information.

## 25.17 {#25-17}

Consult the
[25.17 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.17)
for more information.

## 25.16 {#25-16}

Consult the
[25.16 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.16)
for more information.
...
Consult the
[25.14 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.14)
for more information.

## 25.13 {#25-13}

Consult the
[25.13 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.13)
for more information.

## 25.12 {#25-12}

Consult the
[25.12 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.12)
for more information.

## 25.11 {#25-11}

Consult the
[25.11 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.11)
for more information.

## 25.10 {#25-10}

Consult the
[25.10 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.10)
for more information.
...
Consult the
[25.06 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.06)
for more information.

## 25.05 {#25-05}

Consult the
[25.05 Tickets](https://wazo-dev.atlassian.net/issues/?jql=project%20%3D%20WAZO%20AND%20fixVersion%20%3D%2025.05)
for more information.
