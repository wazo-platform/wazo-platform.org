...
Prior to 25.17, these notifications were sent as standard notifications handled and displayed by the
mobile platform. Since 25.17, mobile applications now have control over whether and how to display
those notifications.
