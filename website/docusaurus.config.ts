  ...
  plugins: [
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        sidebarPath: './sidebarsUcDoc.ts',
        // uc-doc/index.md is listed by hand as the "Overview" entry of the UC
        // category, so keep the autogenerated items from repeating it
