...
metal, virtual machines or containers.
        ...
        <div className="row">
          ...
          <div className="item col-lg-4 col-md-6 col-12">
            ...
            <div className="content">
              ...
              <p>
    All the interfaces are mobile and web friendly: REST API, Web sockets and Web hooks.
              </p>
            </div>
          </div>
          <div className="item col-lg-4 col-md-6 col-12">
            ...
            <div className="content">
              ...
              <p>
    Building blocks are micro-services developed in Python.
              </p>
            </div>
          </div>
          <div className="item col-lg-4 col-md-6 col-12">
    ...
    <section id="license" className="license section">
      <div className="container">
        <div className="license-inner">
          ...
          <div className="info">
            <p>
    You may copy, distribute and modify the software as long as you track changes/dates in source files. Any modifications to or software including (via compiler) GPL-licensed code must also be made available under the GPL along with build & install instructions. Mode details at <a href="https://tldrlegal.com/l/gpl-3.0">tldrlegal.com</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <section id="contact" className="contact section has-pattern">
      ...
      <p>Forum: <a href="https://projects.wazo.community/projects/1/boards">https://projects.wazo.community/projects/1/boards</a><br />
Bug tracking: <a href="https://wazo-dev.atlassian.net/">https://wazo-dev.atlassian.net/</a><br />
E-Mail: <a href="mailto:contact@wazo.community">contact@wazo.community</a><br />
Mattermost: <a href="https://mm.wazo.community/wazo-platform/">https://mm.wazo.community/wazo-platform/</a><br />
IRC: #wazo on irc.freenode.net</p>
          </p>
    ...
    <p>Video @ Kamailio World 2019: <a href="https://youtu.be/d1hOR27r4uY?t=2642">Dangerous Demos</a></p>
    <p>Video at the Telecom Application Development Summit 2018: <a href="https://youtu.be/JxKlxPDDnsk">What can you do with Wazo?</a></p>
    <p>Video at the Telecom Application Development Summit 2017: <a href="https://youtu.be/vh43Vt40myY">WAZO Keynote: xCPaaS</a></p>
            </div>
          </div>
          ...
          <div className="info text-center">
            ...
            <ul className="social-icons list-inline">
              ...
              <li className="list-inline-item">
                <a href="https://github.com/wazo-pbx" target="_blank" rel="noopener noreferrer">
