...
The first line of a CSV file contains a list of field names (also sometimes called \"columns\").
Each new line afterwards are users to import. CSV data must respect the following conditions:
...
specified tenant using the [Wazo-Tenant]{.title-ref} header.
...
#:exclamation: The CSV update has been disabled since it does not suport multi-tenants at the moment
