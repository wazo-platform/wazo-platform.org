...
1. Follow the Berofos general configuration (firmware, IP,
   ...
   [Berofos Installation and Configuration](/uc-doc/high_availability/berofos#berofos-installation-and-configuration) page.
...
This behaviour is caused by a bug in asterisk: [ASTERISK-16115](https://issues.asterisk.org/jira/browse/ASTERISK-16115)

It's possible to workaround this bug in Wazo by adding an agent
[subroutine](/uc-doc/api_sdk/subroutine). The subroutine
...
**Note**: The ngrok tunnel will not survive a reboot of the server, you'll have
