...
- The SIP endpoint configuration has been changed to reflect the Asterisk configuration file. If
  you are using one of the following API, you should update your application to the new body of the
...
- The generated SIP configuration file has changed. If you did manual configuration, your changes
  ...
  to add all options to your endpoint configuration. All options are now available through the API.
...
Consult the [20.12
Tickets](https://wazo-dev.atlassian.net/secure/ReleaseNote.jspa?projectId=10011&version=10121) for
more information.
