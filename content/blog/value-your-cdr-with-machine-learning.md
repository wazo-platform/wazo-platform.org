...
| answered | *boolean* |
| start | *datetime* | Date and time when the call landed on the system
| answer | *datetime* | Date and time when the call was answered (empty if called wasn't answered)
| end | *datetime* | Date and time when the call was hung up
...
| DayOfWeek | *integer* | Category variable representing which day of the week the call was placed
| Hour | *integer* | Category variable representing which hour of the day the call was placed
| DestinationContainsStar | *boolean* | Categorical variable representing whether the destination extension contains a star
